...
#16
def test_reg_correct_data(driver):
    ...
    page.enter_firstname_reg('Елена')
    page.enter_lastname_reg('Еленова')
    page.enter_city_reg('Москва')
    page.enter_email_reg('test_test@mail.ru')
    page.enter_pass_reg('12345Qwert1')
    page.enter_pass_conf_reg('12345Qwert1')
    page.btn_click_reg()
